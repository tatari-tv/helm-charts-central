...
*/}}
{{- define "gha-runner-scale-set.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "gha-runner-scale-set.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- else }}
{{- (include "gha-runner-scale-set.fullname" .) }}
{{- end }}
{{- end }}
